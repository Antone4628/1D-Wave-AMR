            ...
            for idx, (metric, title, ax) in enumerate(zip(metrics, titles, axes)):
                ...
                for _, row in df.iterrows():
                    ...
                    try:
                        ...
                        # FIXED: Format annotation based on metric - removed int() for cost_ratio
                        if metric == 'final_l2_error':
                            annotations[ref_idx, budget_idx] = f'{value:.1e}'
                        elif metric == 'cost_ratio':
                            annotations[ref_idx, budget_idx] = f'{value:.3f}'  # FIXED: Removed int(value)
                        else:
                ...
                # Create heatmap with proper colorbar scaling
                sns.heatmap(heatmap_data, 
                           ...
                           # FIXED: Ensure mask handles NaN values properly
